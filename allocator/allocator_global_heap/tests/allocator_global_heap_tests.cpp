...
TEST(allocatorGlobalHeapTests, test3)
{
    ...
    auto first_block = reinterpret_cast<unsigned int*>(allocator_instance->allocate(sizeof(unsigned int),
                                                                                    values_to_allocate_count));
    auto second_block = reinterpret_cast<unsigned int*>(allocator_instance->allocate(sizeof(unsigned long int),
                                                                                     values_to_allocate_count));
    auto third_block = reinterpret_cast<double*>(allocator_instance->allocate(sizeof(double),
                                                                              values_to_allocate_count));
...
TEST(allocatorGlobalHeapTests, test5)
{
    ...
    struct_metainfo* metainfo_instance = reinterpret_cast<struct_metainfo*>(allocator_instance->allocate(
            sizeof(struct_metainfo), 1));
